...
namespace message_onesignal\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('message_onesignal_devices', [
                'userdeviceid' => 'privacy:metadata:userdeviceid',
                'enabled' => 'privacy:metadata:enabled'
            ], 'privacy:metadata:tableexplanation');
        $collection->link_external_location('External onesignal site.', [
    ...
    public static function get_contexts_for_userid(int $userid) : contextlist {
        $sql = "SELECT ctx.id
                  FROM {message_onesignal_devices} mad
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($results as $result) {
            ...
            \core_privacy\local\request\writer::with_context($context)->export_data([
                    get_string('privacy:subcontext', 'message_onesignal'),
    ...
    protected static function delete_data(int $userid) {
        ...
        foreach (static::get_records($userid) as $record) {
            $DB->delete_records('message_onesignal_devices', ['id' => $record->id]);
        }
    }
