YUI.add('moodle-message_onesignal-toolboxes', function (Y, NAME) {

/**
 * Provides a tool for enabling/disabling elements using AJAX/REST.
 *
 * @module moodle-message_onesignal-toolboxes
 */

// The CSS selectors we use.
var CSS = {
    onesignalCONTENT: 'div[data-processor-name="onesignal"]',
    HIDEDEVICE: 'a.hidedevice',
    DEVICELI: 'li.onesignaldevice',
    DIMCLASS: 'dimmed',
...
Y.extend(DEVICETOOLBOX, TOOLBOX, {
    ...
    setup_for_device: function(baseselector) {
        if (!baseselector) {
            baseselector = CSS.onesignalCONTENT;
        }
